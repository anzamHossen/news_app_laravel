...
<html lang="en">
    ...
    <body>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <ul>
                            ...
                            <li class="email-text">akash@gmail.com</li>
                        </ul>
                    </div>
                    <div class="col-md-6">
                        <ul class="right">
                            {{-- <li class="menu"><a href="faq.html">FAQ</a></li>
                            <li class="menu"><a href="{{ route('about-page') }}">About</a></li> --}}
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="ad-section-1">
                            ...
                            <img src="{{ asset('uploads/'.$global_top_ad_data->top_ad_img) }}" alt="#"></a>
                            @else
                            <a href="{{ $global_top_ad_data->top_ad_url }}"><img src="{{ asset('uploads/'.$global_top_ad_data->top_ad_img) }}" alt="#">
                            @endif
                        </div>
                        @endif
                    </div>
       ...
       @yield('mainn_content')
        ...
        @if($home_ad_data->above_search_status == 'Show')
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        @else
                            <a href="{{ $home_ad_data->above_search_url }}">
        ...
        @if($home_ad_data->above_footer_status == 'Show')
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        @else
                            <a href="{{ $home_ad_data->above_footer_url }}">
